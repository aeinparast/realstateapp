...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            یک پسورد بلند و قوی انتخاب کنید.
        </p>
    </header>

    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            <x-input-label for="update_password_current_password" :value="__('گذرواژه فعلی')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('گذرواژه جدید')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('تایید گذرواژه جدید')" />
