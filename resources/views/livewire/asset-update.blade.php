                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap mb-6 -mx-3">
                            ...
                            <div class="w-full px-3 md:w-1/3" hidden>
                                <label class="block mb-2 text-xs font-bold tracking-wide uppercase " for='map'>
                                    مختصات </label>
                                <input wire:model='map' class=" block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border
                ...
                <form wire:submit='uploadImage' class="flex flex-col items-center justify-center w-full gap-4 ">
                    ...
                    <div
                        ...
                        " wire:key='{{$key}}' wire:click='setAsPrimary({{$key}})'
                            style="background-image: url('https://brand.storage.iran.liara.space/{{$photo}}')">
                            <!-- Photo Item DELETE -->
