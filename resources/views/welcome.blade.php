<x-public-layout>
  ...
  <section id="main">
    <h2 class="my-4 text-4xl font-bold text-center text-mahdavi">تازه ترینها</h2>
    <x-latest-assets />
    <div class="flex justify-center w-full my-4">
      <a href="/amlak"
        class="px-4 py-1 font-medium text-center text-white transition-all border-2 rounded bg-mahdavi ring-0 ring-mahdavi border-mahdavi hover:bg-white hover:text-mahdavi hover:ring-4 hover:ring-offset-4">مشاهده
        موارد بیشتر</a>
    </div>
  </section>
  <section id="blog">
    <h2 class="my-4 text-4xl font-bold text-center text-mahdavi">آخرین‌های وبلاگ</h2>
    <x-hot-blog />
    <div class="flex justify-center w-full my-4">
      <a href="{{route('weblog')}}"
        class="px-4 py-1 font-medium text-center text-white transition-all border-2 rounded bg-mahdavi ring-0 ring-mahdavi border-mahdavi hover:bg-white hover:text-mahdavi hover:ring-4 hover:ring-offset-4">مشاهده
