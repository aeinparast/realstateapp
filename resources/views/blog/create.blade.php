<x-app-layout>
    ...
    <div class="mt-2 overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg">
        ...
        <form class="w-full" method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <label for="image"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                        class="font-semibold">برای انتخاب لوگو کلیک کنید</span> یا درگ و دراپ کنید</p>
