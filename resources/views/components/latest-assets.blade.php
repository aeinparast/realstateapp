<div class="flex flex-col justify-center items-center md:grid md:grid-cols-2  xl:grid-cols-4 gap-2 px-2">
    ...
    <div
        class="flex flex-col md:h-full  col-span-1 overflow-hidden transition-transform border-b-2 rounded shadow-xl border-b-brand">
        ...
        <div class="flex flex-col justify-between flex-1 px-6 py-4">
            ...
            <div class="text-lg font-medium mt-7 ">
                @if ($asset['dealType']==2)
                <div
                    class="flex items-center justify-between w-full px-2 py-1 text-base border-2 rounded-md border-brand">
                    <div class="">
